# Generated by Django 5.1.5 on 2026-01-30 18:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'created_at'], name='feed_karmat_user_id_eb3da7_idx')],
            },
        ),
        migrations.CreateModel(
            name='Like',
            ...
            options={
                'indexes': [models.Index(fields=['content_type', 'object_id'], name='feed_like_content_02ca00_idx')],
